  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        'Tailwind CSS', 'Redux', 'React Query', 'Flexbox', 'Bootstrap'
      ],
    },
    {
      ...
      skills: [
        'Node.js', 'Express', 'NestJS', 'REST APIs', 'SQL', 
        'PostgreSQL', 'MongoDB'
      ],
    },
    {
    ...
    },
    {
      ...
      skills: [
        'AI Integration', 'Web3', 'C' , 'Python', 'Tableau', 'NumPy', 'Pandas'
      ],
    },
  ];
